...
const projects = [
  {
    ...
    name: 'Vetro Clothing',
    status: 'LIVE',
    desc: 'Full-stack luxury MERN e-commerce platform with 52+ products, JWT authentication, full cart & checkout flow, COD orders, admin dashboard, and Cloudinary media delivery.',
            ...
            <div className="project-body">
              ...
              <div className="project-links">
                {proj.live ? (
                  <a
                    href={proj.live}
                    className="project-link primary-link sound-btn"
                    target="_blank"
                    rel="noreferrer"
                  >
                    ⚡ Live Site
                ...
                {proj.github ? (
                  <a
                    href={proj.github}
                    className="project-link sound-btn"
                    target="_blank"
                    rel="noreferrer"
                  >
                    📁 GitHub
